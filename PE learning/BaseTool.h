...
#include <stdio.h>
			...
			char dllname[16] = "user32.dll";//-76
			char functionname[16] = "MessageBoxA";//-60
			char info[16] = "2017221003013";//-44
			...
			begin1:
				...
				dec ecx
					...
					pop edi
					mov ebx, edi;
				mov getProcAddr, eax;//GetProcAddress的地址
				...
				sub ebx, 28
					...
					push kernelBase;
				call getProcAddr;
				mov pLoadLibraryExA, eax;//LoadLibrary的地址
				...
				push 0x00000010
					...
					add ebx, 76
					//push eax
					call pLoadLibraryExA; 载入DLL地址

					mov baseOfmsvcr120, eax;
